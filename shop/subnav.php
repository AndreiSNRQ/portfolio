        <div class="nav-bar card d-flex text-center justify-content-center mt-2" >
                <form class="form-inline my-2 my-lg-0">
                    <input class="form mr-sm-2 m-2" onkeyup="myFunction()" id="myInput" type="search" placeholder="Search ">
                </form>
