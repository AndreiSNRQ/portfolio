                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            swal({
                                ...
                                window.location.href = '../User/home';  // Or profile page
                            });
                        });
                    </script>
                ";
...
<body>
    ...
    <script>
        document.getElementById('navbar').addEventListener('mouseenter', function() {
            ...
            const maxX = window.innerWidth - navbar.offsetWidth; // Maximum horizontal position
            const maxY = window.innerHeight - navbar.offsetHeight; // Maximum vertical position

            const randomX = Math.floor(Math.random() * maxX); // Random horizontal position
            const randomY = Math.floor(Math.random() * maxY); // Random vertical position

            navbar.style.position = 'absolute'; // Ensure it's in absolute position so it can move
            navbar.style.left = `${randomX}px`;
            navbar.style.top = `${randomY}px`;
        });
    </script>
